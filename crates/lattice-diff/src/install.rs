...
fn register_diff_actions(registry: &mut CommandRegistry) {
    registry.register_action(
        ...
        ActionSpec {
            apply: Arc::new(|_| Ok(Effect::AppAction(AppEffect::DiffGet))),
            args_schema: vec![],
        },
    );
    registry.register_action(
        ...
        ActionSpec {
            apply: Arc::new(|_| Ok(Effect::AppAction(AppEffect::DiffPut))),
            args_schema: vec![],
        },
    );
    for (name, doc) in [
...
fn register_diff_ex_commands(registry: &mut CommandRegistry) {
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            apply: Arc::new(|_| Ok(Effect::DiffOpen)),
            args_schema: vec![],
    ...
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_range: false,
            parse_args: Arc::new(parse_no_args),
            apply: Arc::new(|ctx| Ok(Effect::DiffOff { force: ctx.bang })),
            args_schema: vec![],
            surface_form: SurfaceForm::Keyword,
        },
    );
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_range: false,
            parse_args: Arc::new(parse_no_args),
            apply: Arc::new(|_| Ok(Effect::Diffthis)),
            args_schema: vec![],
            surface_form: SurfaceForm::Keyword,
        },
    );
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_bang: false,
            accepts_range: false,
            parse_args: Arc::new(parse_required_path),
            apply: Arc::new(apply_diffsplit),
            args_schema: vec![
                ArgSpec {
                    name: "base".into(),
                    kind: ArgKind::String,
                    doc: "File path. Two-way: the baseline; three-way: the common ancestor.".into(),
                    prompt: "base path:".into(),
    ...
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_bang: false,
            accepts_range: false,
            parse_args: Arc::new(parse_optional_bufnr),
            apply: Arc::new(apply_diffget),
            args_schema: vec![ArgSpec {
                name: "bufnr".into(),
                kind: ArgKind::String,
                doc: "Optional buffer number to pull from (required in three-way merge).".into(),
                prompt: "bufnr:".into(),
                default: ArgDefault::None,
                completion: None,
            }],
    ...
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_range: false,
            parse_args: Arc::new(parse_optional_bufnr),
            apply: Arc::new(apply_diffput),
            args_schema: vec![ArgSpec {
                name: "bufnr".into(),
                kind: ArgKind::String,
                doc: "Optional buffer number to push to (required in three-way merge).".into(),
                prompt: "bufnr:".into(),
                default: ArgDefault::None,
                completion: None,
            }],
    ...
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_range: false,
            parse_args: Arc::new(parse_no_args),
            apply: Arc::new(|_| Ok(Effect::DiffAccept)),
            args_schema: vec![],
            surface_form: SurfaceForm::Keyword,
        },
    );
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_range: false,
            parse_args: Arc::new(parse_no_args),
            apply: Arc::new(|_| Ok(Effect::DiffReject)),
            args_schema: vec![],
            surface_form: SurfaceForm::Keyword,
        },
    );
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_range: false,
            parse_args: Arc::new(parse_no_args),
            apply: Arc::new(|_| Ok(Effect::DiffAcceptAll)),
            args_schema: vec![],
            surface_form: SurfaceForm::Keyword,
        },
    );
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_range: false,
            parse_args: Arc::new(parse_no_args),
            apply: Arc::new(|_| Ok(Effect::DiffRejectAll)),
            args_schema: vec![],
            surface_form: SurfaceForm::Keyword,
        },
    );
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_range: false,
            parse_args: Arc::new(parse_no_args),
            apply: Arc::new(|_| Ok(Effect::NextHunk)),
            args_schema: vec![],
            surface_form: SurfaceForm::Keyword,
        },
    );
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_range: false,
            parse_args: Arc::new(parse_no_args),
            apply: Arc::new(|_| Ok(Effect::PrevHunk)),
            args_schema: vec![],
            surface_form: SurfaceForm::Keyword,
        },
    );
    registry.register_ex_command(
        ...
        ExCommandSpec {
            ...
            accepts_range: false,
            parse_args: Arc::new(parse_no_args),
            apply: Arc::new(|_| Ok(Effect::DescribeDiff)),
            args_schema: vec![],
            surface_form: SurfaceForm::Keyword,
        },
    );
