...
impl WitBoundary for NativeAppEffect {
    ...
    fn to_wit(&self) -> Result<WitAppEffect, String> {
        Ok(match self {
            ...
            NativeAppEffect::HalfPageDown => WitAppEffect::HalfPageDown,
            NativeAppEffect::HalfPageUp => WitAppEffect::HalfPageUp,
    ...
    fn from_wit(w: WitAppEffect) -> Result<Self, String> {
        Ok(match w {
            ...
            WitAppEffect::HalfPageDown => NativeAppEffect::HalfPageDown,
            WitAppEffect::HalfPageUp => NativeAppEffect::HalfPageUp,
...
mod tests {
    ...
    fn app_effect_unit_arms_round_trip() {
        for e in [
            ...
            NativeAppEffect::HalfPageDown,
            NativeAppEffect::HalfPageUp,
