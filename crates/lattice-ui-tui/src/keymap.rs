...
fn build_default_keymap() -> Vec<KeymapEntry> {
    ...
    keymap_entry! { mode: Help, chord: "j", doc: "Scroll down one line" },
    keymap_entry! { mode: Help, chord: "k", doc: "Scroll up one line" },
    keymap_entry! { mode: Help, chord: "<Down>", doc: "Scroll down one line" },
    keymap_entry! { mode: Help, chord: "<Up>", doc: "Scroll up one line" },
    keymap_entry! { mode: Help, chord: "<C-d>", doc: "Scroll down one page" },
    keymap_entry! { mode: Help, chord: "<C-u>", doc: "Scroll up one page" },
    keymap_entry! { mode: Help, chord: "<PageDown>", doc: "Scroll down one page" },
    keymap_entry! { mode: Help, chord: "<PageUp>", doc: "Scroll up one page" },
