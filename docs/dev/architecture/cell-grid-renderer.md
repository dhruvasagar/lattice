...
| **S3.c.2–4** | ⛔ planned | Per-overlay focused validation tests: semantic tokens, bg-layer overlays (visual / hlsearch / current_match / substitute / doc-highlight / diagnostic), fold suffix + post-overlay inlay splice. |
