...
| **S3.c.3–4** | ⛔ planned | Per-overlay focused validation tests: bg-layer overlays (visual / hlsearch / current_match / substitute / doc-highlight / diagnostic), fold suffix + post-overlay inlay splice. |
