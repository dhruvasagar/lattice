---
summary: "The configuration + init lifecycle: lattice.toml and init.rs as two front-ends, init.rs loaded FIRST, plugin config deferred via typed plugin-lifecycle events (with-eval-after-load), and the available-vs-enabled minor-mode model. Supersedes the init.rs-as-async-discovered-plugin lifecycle."
related: [init, config, plugin, events, modes, lifecycle, enable-mode, plugin-loaded]
---

# Configuration & init lifecycle
