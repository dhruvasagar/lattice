...
Sequencing + status: [`../operations/slice-plans/host-provider-inversion.md`](../operations/slice-plans/host-provider-inversion.md).
Motivation: the recurring-drift cost analysed in [`comparison-zed.md`](comparison-zed.md) §5.
