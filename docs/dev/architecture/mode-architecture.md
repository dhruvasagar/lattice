...
| M.6       | **LSP sub-modes**. `lsp-completion-mode`, `lsp-diagnostics-mode`, `lsp-hover-mode`, `lsp-signature-mode`, `lsp-format-mode`, `lsp-rename-mode`, `lsp-symbols-mode`, `lsp-code-action-mode`, `lsp-nav-mode`, `lsp-progress-mode`, `lsp-document-highlight-mode`, `lsp-selection-range-mode`, `lsp-folding-mode`, `lsp-inlay-hint-mode`. Each independently toggleable.                                                                                                                                                                                                                                                                                                                                     | `lattice-lsp`                                                               | Each sub-mode independently disable-able; tests cover gating per-feature.                                                                                                                                                     |
