...
The README's [crate map table](../../../README.md) has a one-line purpose +
...
in [`CLAUDE.md`](../../../CLAUDE.md) under "Standing rules" — that file is a
...
|-----|------------|-------------------|
| [`architecture/design.md`](../architecture/design.md) | The design spec (v0.4). Terse, principle-led. | **What should exist and why.** |
| [`operations/implementation.md`](../operations/implementation.md) | Per-feature status ledger, updated per session. | **What currently exists.** Check here before assuming a symbol is implemented. |
