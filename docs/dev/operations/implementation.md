...
landed the peer renderer. **Remaining Phase-8 work:** the bundled
first-party reference plugins (8b) and repackaging the built-in modes
as WASM components.
