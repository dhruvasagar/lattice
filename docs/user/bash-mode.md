---
summary: "bash-mode: the major mode for Bash files (`.sh`, `.bash`, `.zsh`, `.fish`) — tree-sitter highlighting, folds, symbols, and text objects."
related: [bash, languages]
---
...
Bash buffer resolves to its global or default value. Tab width,
...
Detection is by file extension, so a Bash file with an unusual name
