---
summary: "lsp-inlay-hint-mode: per-buffer gate for textDocument/inlayHint — turn it off and inlay hints disappear from this buffer."
...
`textDocument/inlayHint` — the request behind inferred types and parameter names shown inline.
...
Toggling it off means inlay hints disappear from this buffer. Nothing else about the attachment
...
excellent at completion and slow at inlayHint can be kept, with
