---
summary: "lsp-symbols-mode: per-buffer gate for textDocument/documentSymbol and workspace/symbol — turn it off and the symbol pickers come back empty for this buffer."
...
`textDocument/documentSymbol and workspace/symbol` — the request behind the symbol pickers and the outline.
...
Toggling it off means the symbol pickers come back empty for this buffer. Nothing else about the attachment
...
excellent at completion and slow at documentSymbol can be kept, with
