...
- [Options and configuration](options.md) — `:set`, `:customize`, the
  typed-option system these keys live in.
- [Display & layout](display.md) — soft-wrap, gutter, whitespace.
- [Modal editing](modal-editing.md) — the modes the tag reflects.
