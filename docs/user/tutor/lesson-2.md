===============================================================================
=    L A T T I C E   T U T O R   —   L e s s o n   2                        =
===============================================================================

  Lesson 1 covered the basics: modes, movement, delete, yank, change, undo.

  Lesson 2 is about the grammar that makes vim feel like a language.  Once
  you understand the grammar, commands you have never seen before make sense
  at a glance.


===========================================================================
  Lesson 2.1: THE GRAMMAR — [register] [count] operator [count] motion
===========================================================================
  ...
  The insight: you do not memorise combinations.  You memorise operators
  and motions independently, then combine them freely.
...
===========================================================================
  ...
  -- Exercise 1: place cursor ANYWHERE inside the string below, type
     c i " to change the text inside the quotes.  Type replacement
     text, then <Esc>.

  --->  She said "replace this entire phrase" to nobody.

  -- Exercise 2: place cursor anywhere in the function call below,
     type d a ( to delete the parentheses and everything inside them.
...
===========================================================================
  ...
  they multiply together:
      ...
      2 d 3 w   delete 6 words (2 times 3)
...
===========================================================================
  Lesson 2.5: THE DOT OPERATOR — repeat the last change
===========================================================================

  . (dot) repeats the last change — the full [reg][count]op[count]motion
  unit, exactly as you typed it.  This is one of vim's most powerful
  primitives.

  After d i w deletes a word, pressing . deletes the next word under
  the cursor.  After c i " changes a string, pressing . changes the
  next string the cursor lands on.
...
===========================================================================
  Lesson 2.6: THE FORMAT OPERATOR — =
===========================================================================
...
===========================================================================
  ...
  The grammar:    [register] [count] OPERATOR [count] MOTION/TEXT-OBJECT

  Operators:      d  y  c  >  <  =  g~  gU  gu
  Line doubles:   dd  yy  cc  >>  ==  (operator typed twice)

  Text objects:   i/a  +  w W s p " ' ` ( { [ < t
