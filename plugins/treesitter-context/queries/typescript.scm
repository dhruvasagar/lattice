; TC.5 -- TypeScript context scopes (the JavaScript set plus the type
; declarations TS adds).
;
...
(type_alias_declaration) @context
(enum_declaration body: (_) @context.end) @context
(abstract_class_declaration body: (_) @context.end) @context
