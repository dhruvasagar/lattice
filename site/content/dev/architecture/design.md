...
>
> The companion ledger [`../operations/implementation.md`](../operations/implementation)
...
- **§5.8.1/§5.8.2 refined (2026-06-24, CR.6) -- modes own their
  *command declarations* + the `Effect` boundary made explicit.**
  ...
  paths — see the audit
  [`../audit/effect-dispatch.md`](../audit/effect-dispatch).
