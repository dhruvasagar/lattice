...
[`docs/../archive/8i-approach.md`](../archive/8i-approach): goal, the
...
See [slice plan: keymap-substrate](../archive/keymap-substrate)
...
Full carving in
[slice plan: help-prefix](../archive/help-prefix).
...
See the slice plan
([mode-activation](../operations/slice-plans/archive/mode-activation), SN.3c.2b)
for sequencing and the landed commit.

## See also

- [slice plan: lattice-keymap crate + layer-trace](../operations/slice-plans/keymap-impl-plan) -- T1-T13 sequencing.
