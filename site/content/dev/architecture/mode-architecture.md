...
[`docs/dev/operations/slice-plans/mode-ownership-cleanup.md`](../operations/slice-plans/mode-ownership-cleanup).
...
- `diff-mode`'s `do` / `dp` chords still use the older
  ...
  [`../operations/slice-plans/mode-ownership-cleanup.md`](../operations/slice-plans/mode-ownership-cleanup)
...
- New modes implement `Mode::keymap()` and return a populated
  ...
  [`mode-keymap-authoring.md`](../notes/mode-keymap-authoring)
