+++
title = "Plugin tree-sitter seam — structural queries for plugins"
+++
...
([`../operations/slice-plans/archive/plugin-treesitter-seam.md`](../operations/slice-plans/archive/plugin-treesitter-seam)):
