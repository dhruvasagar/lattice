+++
title = "surround-mode — vim-surround semantics as a native minor mode"
+++
...
> [`../operations/slice-plans/surround-mode.md`](../operations/slice-plans/surround-mode).
> Companion fragments:
> [`design.md`](../design/) (§5.8.3 — bundled plugin candidates),
> [`plugin-auto-pair.md`](../plugin-auto-pair/) (the first bundled plugin, structural template).
...
[`keymap-architecture.md`](../keymap-architecture/) §12 for the flag's mechanism.

## 3. Keymap surface

All bindings land at `KeymapLayer::MinorMode(surround-mode)`. Refer to
[`keymap-architecture.md`](../keymap-architecture/) for the layered keymap model.
...
See [`../operations/slice-plans/surround-mode.md`](../operations/slice-plans/surround-mode).
