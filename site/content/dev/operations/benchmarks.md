...
[`../archive/gpui-perf-plan.md`](../archive/gpui-perf-plan)) closed.
...
[`fold-architecture.md`](../architecture/fold-architecture) §4.
...
edit on every recognised buffer. The Option B migration ([Steps 1–4](../docs/implementation))
...
[`../notes/lsp-features.md`](../notes/lsp-features); the architecture in
[`../architecture/lsp-architecture.md`](../architecture/lsp-architecture). Per-feature
